...
class DebugReport(BaseModel):
    ...
    assumptions: List[str] = Field(description="Assumptions made due to missing or unclear information")
    ...
    confidence_explanation: str = Field(description="Reason behind the confidence score")